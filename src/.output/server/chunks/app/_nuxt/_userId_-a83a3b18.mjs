    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Card, null, {
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<h1 class="text-3xl mb-4 text-center"${_scopeId}>${ssrInterpolate((_a = unref(testInfo)) == null ? void 0 : _a.upComingTest.test.title)}</h1><div class="flex flex-row justify-between"${_scopeId}><h2${_scopeId}>${ssrInterpolate((_b = unref(testInfo)) == null ? void 0 : _b.user.firstName)} ${ssrInterpolate((_c = unref(testInfo)) == null ? void 0 : _c.user.lastName)} v\xE1laszai</h2><p${_scopeId}>${ssrInterpolate((_d = unref(testInfo)) == null ? void 0 : _d.reachedPoints)} / ${ssrInterpolate((_e = unref(testInfo)) == null ? void 0 : _e.maxPoints)} pont</p></div>`);
          } else {
            return [
              createVNode("h1", { class: "text-3xl mb-4 text-center" }, toDisplayString((_f = unref(testInfo)) == null ? void 0 : _f.upComingTest.test.title), 1),
              createVNode("div", { class: "flex flex-row justify-between" }, [
                createVNode("h2", null, toDisplayString((_g = unref(testInfo)) == null ? void 0 : _g.user.firstName) + " " + toDisplayString((_h = unref(testInfo)) == null ? void 0 : _h.user.lastName) + " v\xE1laszai", 1),
                createVNode("p", null, toDisplayString((_i = unref(testInfo)) == null ? void 0 : _i.reachedPoints) + " / " + toDisplayString((_j = unref(testInfo)) == null ? void 0 : _j.maxPoints) + " pont", 1)
              ])
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/test-results/teacher/[upcomingTestId]/[userId].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_userId_-a83a3b18.mjs.map
